...
export const projects: Project[] = [
  {
    ...
    screenshots: [
      '/screenshots/apiguard/dashboard.png',
      '/screenshots/apiguard/monitoring.png',
      '/screenshots/apiguard/contract-changes.png',
      '/screenshots/apiguard/incident.png',
      '/screenshots/apiguard/alerts.png',
      '/screenshots/apiguard/billing.png',
    ],
    tags: [
      'Next.js',
      'React',
    ...
    demo: 'https://apiguard.devyoung.dev',
    featured: true,
  ...
  },
  {
    ...
    demo: 'https://find-it-alpha.vercel.app',
    featured: true,
    role: 'Frontend Developer with Backend Contributions',
  ...
  },
  {
    ...
    demo: 'https://brevoca-web.vercel.app',
    featured: true,
    role: 'Solo Developer',
